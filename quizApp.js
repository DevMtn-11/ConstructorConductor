...
//Let's say three people signed up for our service, create 3 instances of User and add each to the users Array
  ...
  //code here
quizUsers.push(new QuizUser('Nick', 'nick@gmail.com', 'iamnick', 0));
quizUsers.push(new QuizUser('James', 'james@gmail.com', 'iamjames', 0));
quizUsers.push(new QuizUser('Joe', 'joe@gmail.com', 'iamjoe', 0));
...
//Fill in the rest of the required data as you see appropriate.
  ...
  //code here
var q1 = new Question('T/F: Inheritance is achieved in JavaScript through Prototypes?', [true, false], true, 2);
...
//Now loop console.log your users array and your questions array and verify that they're both holding the right data.
  ...
  //code here
console.log(quizUsers, questions);
